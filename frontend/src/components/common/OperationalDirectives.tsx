...
const DEFAULT_DIRECTIVES: OperationalDirective[] = [
  {
    ...
    title: 'Mandatory Tier-1 Evacuation: Chooralmala Sector (DM Act 2005 Sec 34)',
    target: 'Chooralmala Riverine Basin & Hamlet',
    urgency: 'P1_IMMEDIATE',
    rationale: 'Fs 0.88 with 1,420 citizens in high-velocity runout zone. Broadcasted via NDMA Sachet CAP-CP & KSDMA.',
  ...
  },
  {
    ...
    title: 'Arterial Road Closure: SH-59 Wayanad Ghat & Chooralmala Bridge',
    target: 'SH-59 Corridor & Bridge Abutment',
    urgency: 'P1_IMMEDIATE',
    rationale: 'Pore pressure 68.4 kPa and Iruvanjippuzha flash surge threaten bridge stability. Kerala Police & PWD detour.',
    status: 'ACTIVE',
  ...
  },
  {
    ...
    title: 'Deploy NDRF 4th Battalion Squad Alpha with Canines & Ground Radar',
    target: 'Meppadi Emergency Forward Base',
    urgency: 'P1_IMMEDIATE',
    rationale: 'Mobilize 60 NDRF disaster responders with victim-locating cameras, life-detectors, and inflatable boats.',
    status: 'PENDING_DISPATCH',
    affected_population: 0,
    evidence_metric: 'NDRF 4th Bn • Arakkonam QRT',
  },
  {
    id: 'DIR-04',
    action_type: 'FIELD_DISPATCH',
    title: 'Mobilize Indian Army Madras Sappers (Engineers) 190-ft Bailey Bridge',
    target: 'Chooralmala-Mundakkai River Crossing',
    urgency: 'P2_HIGH',
    rationale: 'Pre-position 24-ton heavy military Bailey Bridge assembly to ensure lifeline connectivity across flooded river.',
    status: 'PENDING_DISPATCH',
    affected_population: 850,
    evidence_metric: 'Indian Army Sappers • 190ft Cl-24',
  },
  {
    id: 'DIR-05',
    action_type: 'RELIEF_SHELTER',
    title: 'Activate Aapda Mitra Community First Responder Volunteer Grid',
    target: 'Government Higher Secondary School Meppadi',
    urgency: 'P2_HIGH',
    rationale: 'Mobilize 45 certified Aapda Mitra volunteers for vernacular loudspeaker alerts, first aid, and community kitchen.',
    status: 'PENDING_DISPATCH',
    affected_population: 800,
    evidence_metric: 'Aapda Mitra • NDMA Certified',
  },
  {
    id: 'DIR-06',
    action_type: 'INFRA_SHUTDOWN',
    title: 'KSEB 66kV Electrical Substation Isolation: Prevent Electrocution',
    target: 'Chooralmala Riverine Feeder Line',
    urgency: 'P1_IMMEDIATE',
    rationale: 'De-energize inundated low-tension power lines to safeguard evacuees and rescue personnel.',
    status: 'PENDING_DISPATCH',
    affected_population: 0,
    evidence_metric: 'KSEB Feeder #4 • 66kV Grid',
  }
];
