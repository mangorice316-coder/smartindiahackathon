...
export const KpiSkeleton: React.FC = () => (
  <div className="c2-card rounded-2xl p-5 border-[#253042] animate-pulse space-y-3">
...
export const ChartSkeleton: React.FC = () => (
  <div className="c2-card rounded-2xl p-5 border-[#253042] animate-pulse space-y-4">
    <div className="flex justify-between items-center">
...
export const IncidentSkeleton: React.FC = () => (
  <div className="c2-card rounded-2xl p-6 border-[#253042] animate-pulse space-y-4">
